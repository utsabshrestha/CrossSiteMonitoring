...
namespace DataAccessLibrary.DataAccess
{
    public class Inventory : IInventory
    {
        ...
        {
            string query = @"select id.ini_id,id.road_code,id.road_name,id.district,id.date,ur.observer_name,id.observer_email,ur.designation,cod.cons_id,cod.form_id,cod.construction_type,cod.location_type,cod.location,cod.observation_notes,cod.quality_rating,cod.latitude,
                            cod.longitude,cod.line_latitude_from,cod.line_longitude_from,cod.line_latitude_to,cod.line_longitude_to,cod.altitude,f.file_id,f.file_name,f.file_note,f.unique_file,f.file_type from monitoring.initial_details id
                            join(select * from monitoring.construction_observation_detail)cod on cod.initials_id=id.ini_id            
                            left join(select * from monitoring.file)f on f.form_id=cod.form_id
